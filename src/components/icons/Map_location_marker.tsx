...
export const Map_location_marker = () => {
    return (
<svg className={"lucide lucide-map-pinned block text-gray-400"} xmlns={"http://www.w3.org/2000/svg"} width={"16"} height={"16"} viewBox={"0 0 24 24"} fill={"none"} stroke={"currentColor"} strokeWidth={"2"} strokeLinecap={"round"} strokeLinejoin={"round"}>
...
export default Map_location_marker
