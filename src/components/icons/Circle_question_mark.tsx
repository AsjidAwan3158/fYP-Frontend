...
export const Circle_question_mark = () => {
    return (
<svg xmlns={"http://www.w3.org/2000/svg"} width={"18"} height={"18"} viewBox={"0 0 24 24"} fill={"currentColor"} className={"icon icon-tabler icons-tabler-filled icon-tabler-help-circle"}>
...
export default Circle_question_mark
